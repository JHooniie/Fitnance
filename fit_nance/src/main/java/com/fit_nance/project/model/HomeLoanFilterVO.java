...
public class HomeLoanFilterVO {
	...
	public ArrayList<String> getList_mrtg_type() {
		return list_mrtg_type;
	}
	public void setList_mrtg_type(ArrayList<String> list_mrtg_type) {
		this.list_mrtg_type = list_mrtg_type;
	}
