...
public class HomeLoanOptService {
	public ArrayList<HomeLoanOptVO> homeloanOpt() throws Exception{
		...
		StringBuilder urlBuilder = new StringBuilder("http://finlife.fss.or.kr/finlifeapi/mortgageLoanProductsSearch.json?auth=c2c7484c2f7707de0e03bf8ddb9d735d&topFinGrpNo=020000&pageNo=1");
