...
public class PersonalLoanOptService {
	public ArrayList<PersonalLoanOptVO> personalloanOpt() throws Exception{
		...
		StringBuilder urlBuilder = new StringBuilder("http://finlife.fss.or.kr/finlifeapi/creditLoanProductsSearch.json?auth=c2c7484c2f7707de0e03bf8ddb9d735d&topFinGrpNo=020000&pageNo=1");
