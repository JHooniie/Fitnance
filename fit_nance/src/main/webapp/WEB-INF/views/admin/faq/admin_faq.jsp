...
<html>
	<head>
		...
		<script src="<c:url value='/js/admin/admin_faq.js'/>"></script>
	</head>
	<body id="page-top">
		<!-- Page Wrapper -->
	    <div id="wrapper">
	                    ...
	                    <div class="card shadow mb-4">
	                        <div class="card-header py-3 form-inline" style="justify-content: space-between;">
	                            ...
	                            <div>
	                                ...
	                                <button type="button" id="deleteFAQBtn" class="btn btn-danger">삭제</button>
	                            </div>                            
	                        </div>
	                        <div class="card-body">
	                                    	...
	                                    	<c:forEach items="${FAQList}" var="FAQ">
	                                    		<tr>
		                                            <td class="align-middle">
		                                                <div class="form-check form-check-inline ml-3">
		                                                    <input class="form-check-input chkDelete" type="checkbox" name="chkDelete" data-faqIndex="${FAQ.FAQIndex}">                                                   
		                                                </div>
		                                            </td>
		                                            <td class="align-middle">${FAQ.FAQIndex}</td>
		                                            <td class="align-middle">${FAQ.FAQTitle}</td>
		                                            <td class="align-middle">${FAQ.adminId}</td>
		                                            <td class="align-middle">
		                                            	<a href="<c:url value='/admin/FAQDetailView/${FAQ.FAQIndex}'/>" class="btn btn-light btn-sm">상세보기</a>
		                                            </td>
		                                        </tr>
	                                    	</c:forEach>
	                                    </tbody>
