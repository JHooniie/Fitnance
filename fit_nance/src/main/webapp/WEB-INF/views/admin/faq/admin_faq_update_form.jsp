	                    ...
	                    <div class="card shadow mb-4">
	                        <div class="card-body">
	                            <div class="table-responsive">
	                                <form method="post" action="<c:url value='/admin/updateFAQ'/>">
	                                    <table class="table table-bordered">
	                                        <tr>
	                                            <th class="align-middle">제목</th>
	                                            <td>
	                                                <input type="text" name="FAQTitle" id="FAQTitle" class="form-control" placeholder="제목을 입력해주세요" value="${FAQ.FAQTitle}">
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                    ...
	                                    <input type="hidden" name="FAQIndex" value="${FAQ.FAQIndex}">
	                                    <div class="box-btn">
