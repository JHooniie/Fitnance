	            ...
	            <div id="content">
	                ...
	                <div class="container-fluid">
	                    ...
	                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
	                        <h1 class="h3 mb-0 text-gray-800">문의 사항 답변</h1>
	                    </div>
	
	                    <div class="card shadow mb-4">
	                        <div class="card-body">
	                            <div class="table-responsive">
	                                <form method="post" action="<c:url value='/admin/updateQNA/${a.qIndex }'/>">
	                                    <table class="table table-bordered">
	                                        <tr>
	                                            <th class="align-middle">제목</th>
	                                            <td>
	                                                <input type="text" name="aTitle" id="aTitle" class="form-control" placeholder="제목을 입력해주세요" value="${a.aTitle}">
	                                            </td>
	                                        </tr>
	                                        <tr>
	                                    ...
	                                    <input type="hidden" name="FAQIndex" value="${a.qIndex}">
	                                    <div class="box-btn">
