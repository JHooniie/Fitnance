                    ...
                    <div class="item-box-all">
                        <div class="item-box">
                            ...
                            <div class="text-box">
                                ...
                                <div class="item-line">
                                    <div class="item-name">${list.fin_prdt_nm }<span>영업점</span><span>인터넷</span><span>스마트폰</span></spna></div>
                                </div>
                            </div>
                        ...
                        <div class="item-box2">
                            ...
                            <div class="view-detail"><a href="<c:url value='deposit_detail'/>">자세히 보기</a></div>
                        </div>
                    </div>
                    </c:forEach>
                    <!-- <div class="item-box-all">
